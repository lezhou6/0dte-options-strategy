"""Fetch 5m interval SPY raw greeks and open interest from ThetaData and store as parquet files."""
...
GREEKS_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "data", "raw_5min", "greeks")
OI_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "data", "raw_5min", "oi")
